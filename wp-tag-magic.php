<?php
/*
Plugin Name: Wordpress Tag Magic
Plugin URI: http://www.guidingwp.com/wordpress-tag-magic-widget/
Description: Adds a sidebar widget or shortcode to display selected categories as a tag cloud with posts count.
